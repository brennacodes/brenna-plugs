...
8. **Voice profile (optional)**: Use AskUserQuestion:
...
9. **Confirm**: Tell the user their config has been saved and they can now use `/mark-my-words:new-post`, `/mark-my-words:update-post`, and `/mark-my-words:manage-post`.
