---
name: setup
description: "Configure what-do-you-know plugin: link to shared trio config, set learning preferences, seed personas, and initialize learning session tracking"
