...
Reference for scoring and conducting explore sessions.

## Learning Dimensions

### Depth (1-5)

How far below the surface can they explain?
...
Are their mental models technically correct?
...
Can they relate this to adjacent concepts and their own experiences?
...
Can they apply the knowledge to new situations?
...
Can they explain it clearly to someone else?
...
Goal: Map the landscape. Identify what they know and don't.
...
Goal: Go deep on identified areas. Test boundaries.

- Start from a known anchor: "You mentioned X. Let's go deeper."
- Push to edge of knowledge: "What happens when...?"
- Test for misconceptions: present a slightly wrong statement and see if they catch it
- Explore tradeoffs: "Why would you choose X over Y?"

### Deep

Goal: Stress-test mental models. Challenge assumptions.

- Present edge cases and failure modes
- Ask "what would happen if" scenarios
- Challenge with counterexamples
- Demand precision on terminology and mechanism
- Test ability to derive from first principles

## Concept Classification

### Strong
- Can explain mechanism, not just behavior
- Can identify tradeoffs and limitations
- Can connect to personal experience
- Can teach it to someone else
- Evidence: high scores across all dimensions

### Partial
- Understands the basics correctly
- Some gaps in depth or precision
- Can use it but can't always explain why
- May have minor misconceptions
- Evidence: moderate scores, uneven across dimensions

### Gap
- Awareness without understanding
- Significant misconceptions present
- Can't explain mechanism or tradeoffs
- No connection to personal experience
- Evidence: low scores, especially in depth and accuracy
