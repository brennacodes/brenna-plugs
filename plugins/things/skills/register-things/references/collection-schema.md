...
Each collection in the registry defines how a plugin's data is structured on disk. This schema is used by the `/register-things` skill and by the setup skills of individual plugins.
