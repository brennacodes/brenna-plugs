...
<steps>
  ...
  <step id="confirm" number="12">
    ...
    Next steps:
    - `/resume-plan-pb <plan-slug>` -- Pick up implementation where you left off
    - `/implement-pb <review-filename>` -- Implement specific actionable items
    - `/progress-pb <plan-slug>` -- See full progress dashboard
    </completion-message>
  </step>
