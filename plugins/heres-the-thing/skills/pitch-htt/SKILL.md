...
<steps>
  ...
  <step id="generate-deliverables" number="8">
    ...
    **Apply medium-specific additions:**
    ...
    - Q&A prep session (via `/heres-the-thing:prep-htt`)
    </phase>
  </step>
  ...
  <step id="summary" number="9">
    ...
    Next steps:
    - `/heres-the-thing:prep-htt <campaign-id>` -- refine deliverables or run Q&A prep
    - `/heres-the-thing:outcome-htt <campaign-id>` -- log what happened after delivery
    - `/heres-the-thing:review-htt` -- analyze patterns across campaigns
    </completion-message>
  </step>
