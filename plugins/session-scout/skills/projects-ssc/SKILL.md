...
<steps>
  ...
  <step id="interaction" number="3">
    ...
    <completion-message>When showing the project list, tell the user they can drill into any project by running `/projects-ssc <name>` to see its sessions.</completion-message>
  </step>
