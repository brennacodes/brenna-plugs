...
```
/active          # Show 10 most recent sessions (default)
/active 20       # Show 20 most recent sessions
```
</purpose>
...
<steps>
  ...
  <step id="interaction" number="3">
    ...
    <completion-message>Tell the user they can ask for the resume command for any session by its number (e.g., "Show me #3") or use `/resume <id>` with the session ID.</completion-message>
  </step>
